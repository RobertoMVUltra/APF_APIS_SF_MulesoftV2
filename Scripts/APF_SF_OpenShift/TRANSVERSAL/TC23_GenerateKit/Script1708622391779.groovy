...
ResponseObject responseGenerarKit = WS.sendRequest(findTestObject('Postman/Transversal/GenerateKit WIP/GenerateKit', [('curp') : CURP
            , ('quoteId') : quoteId]))
...
//ResponseObject responseDocumURL = WS.sendRequest(findTestObject('Postman/Transversal/GetDocumentURL WIP/GetDocumentURL', [('Id') : vId]))
//
...
while(url=='') 
{
	...
	print(jsonResponseDocumURL)
	url = jsonResponseDocumURL.publicUrl
}


print(url)
GlobalVariable.URLKIT_PDF=url
