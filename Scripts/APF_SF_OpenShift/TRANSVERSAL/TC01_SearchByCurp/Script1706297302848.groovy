...
//Se valida el curp agregar en el request

def msjStatus=CustomKeywords.'validarCurp.ValidarResponseCurp.ValidarCurpIngresado'(jsonResponseGetCurp)

WS.comment(msjStatus)
