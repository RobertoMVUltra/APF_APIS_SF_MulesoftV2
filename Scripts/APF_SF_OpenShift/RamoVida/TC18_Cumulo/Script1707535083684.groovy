...
ResponseObject responseCumulo = WS.sendRequest(findTestObject('Postman/Vida/Cumulo/Cumulo', [('rfc') : rfc, ('paterno') : paterno, ('materno') : materno
            , ('nombre') : FirstName, ('sumaAsegurada') : sumaAsegurada, ('edad') : edad]))
