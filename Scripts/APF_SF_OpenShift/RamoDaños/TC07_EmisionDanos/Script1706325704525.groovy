...
WebUI.callTestCase(findTestCase('APF_SF_OpenShift/RamoDaños/TC05_GetHomePackages'), [('pq') : pq, ('PorcentajeContenidos') : PorcentajeContenidos
        ...
        , ('AplicaDmrbR') : AplicaDmrbR, ('CodigoPostalR') : CodigoPostalR, ('ValorContenidosR') : ValorContenidosR], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('APF_SF_OpenShift/RamoDaños/TC06_CreateQuoteDanos'), [('PhoneNumber') : PhoneNumber, ('Email') : Email
        ...
        , ('CardMonth') : CardMonth, ('CardNumber') : CardNumber, ('CardYear') : CardYear, ('pq') : pq], FailureHandling.CONTINUE_ON_FAILURE)
...
//
//Regresamos a la pagina de correos temporales
//
//WebUI.switchToWindowIndex(currentWindow)
//
//WebUI.waitForElementVisible(findTestObject('Object Repository/CORREO_TEMP/btn_seleccionarActivar'), 80)
//WebUI.scrollToElement(findTestObject('Object Repository/CORREO_TEMP/btn_seleccionarActivar'), 0)
//
////Abrir correo
//WebUI.click(findTestObject('Object Repository/CORREO_TEMP/btn_seleccionarActivar'))
//
//WebUI.closeBrowser()
//
//
