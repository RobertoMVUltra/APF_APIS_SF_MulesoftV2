...
ResponseObject responseAnioVehiculo = WS.sendRequest(findTestObject('Postman/Autos/AnioVehiculos/AnioVehiculos', [('codMarca') : codMarca, ('codModelo') : codModelo]))
...
//print(jsonResponseAnioVehiculo)
