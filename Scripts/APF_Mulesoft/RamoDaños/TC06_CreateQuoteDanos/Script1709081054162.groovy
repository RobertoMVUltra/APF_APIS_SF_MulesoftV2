...
if (GlobalVariable.STATUSRESTPQ) {
    ...
    WebUI.callTestCase(findTestCase('APF_Mulesoft/TRANSVERSAL/TC12_GetReceiptsData'), [('price') : rpPaquete[pq].price, ('total') : rpPaquete[
            pq].total, ('taxAmount') : rpPaquete[pq].taxAmount, ('priceWithExpense') : rpPaquete[pq].priceWithExpense, ('expense') : rpPaquete[
            pq].expense, ('numInstallments') : numInstallments, ('productCode') : rpPaquete[pq].productCode], FailureHandling.STOP_ON_FAILURE)
