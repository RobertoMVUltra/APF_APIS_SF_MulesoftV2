...
//Se recuperar la respuesta de GetReceiptsData
...
GlobalVariable.PRIMERPAGO = jsonResponseGetReceiptsData.installmentAmount

WS.comment('Primer Pago:' + GlobalVariable.PRIMERPAGO)
