...
if (GlobalVariable.STATUSRESTPQ) {
    ...
    if (GlobalVariable.BRANCHCODE == 'VI47') {
        ...
        WebUI.callTestCase(findTestCase('APF_Mulesoft/TRANSVERSAL/TC12_GetReceiptsData'), [('price') : rpPaquete.packages[
                pq].price, ('total') : rpPaquete.packages[pq].price, ('taxAmount') : 0, ('priceWithExpense') : 0, ('expense') : 0
                , ('numInstallments') : numInstallments, ('productCode') : rpPaquete.packages[pq].code], FailureHandling.STOP_ON_FAILURE)
    ...
    ResponseObject responseCreateQuote = WS.sendRequest(findTestObject('Migracion Mulesoft/Salesforce/Transversal/CreateQuote for All/MS_CreateQuote', 
